...
<head>
    ...
    <title>NICE ADMIN - Midify On Laravel 10 By - SATiYA.CH</title>
    <meta content="" name="description">
    <meta content="" name="keywords">
    <!-- Favicons -->
    <link href="{{ asset('nice/assets/img/logo.png') }}" rel="icon">
    <link href="{{ asset('nice/assets/img/logo.png') }}" rel="apple-touch-icon">
    <!-- Google Fonts -->
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Nice Admin Template - Bootstrap 5</h1>
            <small class="text-muted">Midify On Laravel 10 By - SATiYA.CH</small>
        </div>
        @yield('content')
    </main>
    <!-- End #main -->
